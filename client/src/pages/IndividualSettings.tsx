...
import { User, Settings, Bell, Shield, FileText, Trash2, Save } from "lucide-react";
...
export default function IndividualSettings() {
  ...
  useEffect(() => {
    document.title = "Individual Settings | Sebenza Hub";
  }, []);

  // Fetch profile
  const { data: profileData } = useQuery<{ success: boolean; profile: CandidateProfile }>({
    queryKey: ["/api/individual/profile"],
  });
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (data: any) => {
      return apiRequest("PATCH", "/api/individual/profile", data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/individual/profile"] });
      toast({
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={experienceLevel} onValueChange={setExperienceLevel}>
                    <SelectTrigger id="experienceLevel" data-testid="select-experience">
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        and remove your data from our servers. You will receive a confirmation
